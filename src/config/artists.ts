...
export const residents: ResidentArtist[] = [
  ...
  },
  {
    ...
    styleIds: ['fineline', 'realismus-bw'],
  },
  {
    id: 'roli',
    name: 'Roli',
  ...
  },
  {
    ...
    roleEn: 'Resident Artist',
    instagram: '@n.ana.ink',
    portrait: '/images/artists/nana.webp',
    portfolio: ['/images/artists/nana.webp'],
    styleIds: ['realismus-bw', 'fineline'],
  },
  {
    id: 'hera',
    name: 'Hera',
    ...
    roleEn: 'Resident Artist',
    instagram: '@hera.ttt',
    portrait: '/images/artists/hera.webp',
    portfolio: ['/images/artists/hera.webp'],
    styleIds: ['anime', 'illustrativ'],
  },
  {
    id: 'tati',
    name: 'Tati',
    ...
    portrait: '/images/artists/tati.webp',
    portfolio: ['/images/artists/tati.webp'],
    styleIds: ['fineline'],
  },
  {
    id: 'veronika',
    ...
    roleDe: 'Resident Artist',
    roleEn: 'Resident Artist',
    instagram: '@veroni.ink',
    portrait: '/images/artists/veronika.webp',
    portfolio: ['/images/artists/veronika.webp'],
    styleIds: ['watercolor'],
  },
];
